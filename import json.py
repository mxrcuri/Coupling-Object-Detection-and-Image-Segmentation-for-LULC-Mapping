...
# from keras.api.metrics import MeanIoU
import random
...
root_directory = 'F:\Ashish\Composite'
...
# for path, subdirs, files in os.walk(root_directory):
    ...
    #print(dirname)
image_name =r"Composite13_Rectified.tif"  #List of all image names in this subdirectory
    #print(images)
    
#print(image_name)
image = cv2.imread(r'F:\Ashish\Composite\Composite13_Rectified.tif')  #Read each image as BGR
...
patches_img = patchify(image, (1280, 1280, 3), step=1280)  #Step=256 for 256 patches means no overlap
img="cut"
for i in range(patches_img.shape[0]):
    for j in range(patches_img.shape[1]):
        ...
        cv2.imwrite(r"C:\Users\PC-17\Desktop\hello\carto"+ 
                    img +"patch_"+str(i)+str(j)+".jpg", single_patch_img)
        ...
        if mask_name.endswith(".png"):           
            ...
            for i in range(patches_mask.shape[0]):
                for j in range(patches_mask.shape[1]):
                    ...
                    cv2.imwrite("filtered train/"+"256_patches/masks/"+
                               mask_name+"patch_"+str(i)+str(j)+".png", cv2.cvtColor(single_patch_mask, cv2.COLOR_RGB2BGR))

"""
"""
train_img_dir = "filtered train/256_patches/images/"
train_mask_dir = "filtered train/256_patches/masks/"
...
# input_folder = 'filtered train/256_patches/'
# output_folder = 'filtered train/data_for_training_and_testing/'
# # Split with a ratio.
